...
def interact_with_user():
    ...
    while True:
        ...
        if choice == "1":
            ...
            tag = input("Enter index of the note to edit: ")
            if tag is None:
                print("Invali note index.")
            else:
                new_content = input("Enter new text for the note: ")
                notes_manager.edit_note_content(tag, new_content)
        elif choice == "5":
            index = input("Enter index of the note to delete: ")
